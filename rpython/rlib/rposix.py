...
if os.name == 'nt':
    ...
    c_enter_suppress_iph = external("enter_suppress_iph",
                                  [], rffi.VOIDP, compilation_info=errno_eci)
    c_exit_suppress_iph = external("exit_suppress_iph",
                                  [rffi.VOIDP], lltype.Void,
                                  compilation_info=errno_eci)
    c_enter_suppress_iph_del = external("enter_suppress_iph",
                                  [], rffi.VOIDP, compilation_info=errno_eci,
                                  releasegil=False)
    c_exit_suppress_iph_del = external("exit_suppress_iph",
